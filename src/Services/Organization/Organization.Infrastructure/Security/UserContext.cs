...
namespace Organization.Infrastructure.Security
{
    public class UserContext : IUserContext
    {
        ...
        public CurrentUser? GetCurrentUser()
        {
            ...
            _ = Guid.TryParse(user.FindFirstValue(CustomClaimTypes.EmployeeId), out var employeeId);
            _ = Guid.TryParse(user.FindFirstValue(CustomClaimTypes.OrganizationId), out var organizationId);
