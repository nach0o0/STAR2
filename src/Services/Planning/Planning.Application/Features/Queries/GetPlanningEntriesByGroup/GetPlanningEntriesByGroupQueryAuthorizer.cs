...
{
    public class GetPlanningEntriesByGroupQueryAuthorizer : ICommandAuthorizer<GetPlanningEntriesByGroupQuery>
    {
        public Task AuthorizeAsync(GetPlanningEntriesByGroupQuery query, CurrentUser currentUser, CancellationToken cancellationToken)
        {
