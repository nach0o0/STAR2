...
{
    public class RemoveRoleFromUserCommandAuthorizer : ICommandAuthorizer<RemoveRoleFromUserCommand>
    {
        public Task AuthorizeAsync(RemoveRoleFromUserCommand command, CurrentUser currentUser, CancellationToken cancellationToken)
        {
