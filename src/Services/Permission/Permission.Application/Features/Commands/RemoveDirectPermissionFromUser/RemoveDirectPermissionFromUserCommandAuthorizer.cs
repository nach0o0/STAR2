...
{
    public class RemoveDirectPermissionFromUserCommandAuthorizer : ICommandAuthorizer<RemoveDirectPermissionFromUserCommand>
    {
        public Task AuthorizeAsync(RemoveDirectPermissionFromUserCommand command, CurrentUser currentUser, CancellationToken cancellationToken)
        {
