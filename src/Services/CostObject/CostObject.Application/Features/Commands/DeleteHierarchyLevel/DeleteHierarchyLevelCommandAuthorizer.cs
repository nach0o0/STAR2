...
{
    public class DeleteHierarchyLevelCommandAuthorizer : ICommandAuthorizer<DeleteHierarchyLevelCommand>
    {
        ...
        public DeleteHierarchyLevelCommandAuthorizer(
        ...
        public async Task AuthorizeAsync(DeleteHierarchyLevelCommand command, CurrentUser currentUser, CancellationToken cancellationToken)
        {
