...
{
    public class UpdateHierarchyDefinitionCommandAuthorizer : ICommandAuthorizer<UpdateHierarchyDefinitionCommand>
    {
        private readonly IHierarchyDefinitionRepository _definitionRepository;

        public UpdateHierarchyDefinitionCommandAuthorizer(IHierarchyDefinitionRepository definitionRepository)
        {
            _definitionRepository = definitionRepository;
        }

        public async Task AuthorizeAsync(UpdateHierarchyDefinitionCommand command, CurrentUser currentUser, CancellationToken cancellationToken)
        {
