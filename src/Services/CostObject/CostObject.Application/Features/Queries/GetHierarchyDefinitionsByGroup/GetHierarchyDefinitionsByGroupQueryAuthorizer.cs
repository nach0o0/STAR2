...
{
    public class GetHierarchyDefinitionsByGroupQueryAuthorizer : ICommandAuthorizer<GetHierarchyDefinitionsByGroupQuery>
    {
        public Task AuthorizeAsync(GetHierarchyDefinitionsByGroupQuery query, CurrentUser currentUser, CancellationToken cancellationToken)
        {
            ...
            throw new ForbiddenAccessException("You must be a member of this group or have hierarchy management permissions to view its definitions.");
        }
    }
}
