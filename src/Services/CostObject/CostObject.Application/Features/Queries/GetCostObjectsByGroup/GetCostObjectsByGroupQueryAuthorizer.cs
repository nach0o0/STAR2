...
{
    public class GetCostObjectsByGroupQueryAuthorizer : ICommandAuthorizer<GetCostObjectsByGroupQuery>
    {
        public Task AuthorizeAsync(GetCostObjectsByGroupQuery query, CurrentUser currentUser, CancellationToken cancellationToken)
        {
            // Fall 1: Ist der Benutzer direkt Mitglied dieser Gruppe?
            ...
            // Wenn keine der Bedingungen zutrifft, wird der Zugriff verweigert.
