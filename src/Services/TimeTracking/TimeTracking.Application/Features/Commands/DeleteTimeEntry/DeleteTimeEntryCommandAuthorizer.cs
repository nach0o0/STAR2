...
{
    public class DeleteTimeEntryCommandAuthorizer : ICommandAuthorizer<DeleteTimeEntryCommand>
    {
        private readonly ITimeEntryRepository _timeEntryRepository;

        public DeleteTimeEntryCommandAuthorizer(ITimeEntryRepository timeEntryRepository)
        {
            _timeEntryRepository = timeEntryRepository;
        }

        public async Task AuthorizeAsync(DeleteTimeEntryCommand command, CurrentUser currentUser, CancellationToken cancellationToken)
        {
            ...
            throw new ForbiddenAccessException("You are not authorized to delete this time entry.");
        }
    }
}
