...
var attendanceApplicationAssembly = typeof(TimeTracking.Application.DependencyInjection).Assembly;
builder.Services
...
var allPermissions = TimeEntryPermissions.AllPermissions;
...
await app.RegisterServicePermissionsAsync("TimeTracking", allPermissions);
